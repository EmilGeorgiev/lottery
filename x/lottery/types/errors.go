...
var (
	...
	ErrInvalidUserAddress        = sdkerrors.Register(ModuleName, 1101, "user address is invalid: %s")
	...
	ErrCannotPayRewards          = sdkerrors.Register(ModuleName, 1104, "cannot pay reward to the winner: %s")
	ErrCannotSendFeesToCollector = sdkerrors.Register(ModuleName, 1105, "cannot send fees to the fee collector: %s")
)
