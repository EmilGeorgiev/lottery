...
type FinishedLottery struct {
	...
	Payment uint64 `protobuf:"varint,3,opt,name=payment,proto3" json:"payment,omitempty"`
}
...
func (m *FinishedLottery) GetPayment() uint64 {
	if m != nil {
		return m.Payment
	}
	return 0
...
var fileDescriptor_b20ea49878d19341 = []byte{
	...
	0x67, 0xa6, 0x96, 0xe9, 0xc1, 0xe4, 0xa0, 0xb4, 0x52, 0x24, 0x17, 0xbf, 0x1b, 0x54, 0x9f, 0x0f,
	...
	0x0b, 0x43, 0x79, 0x42, 0x12, 0x5c, 0xec, 0x05, 0x89, 0x95, 0xb9, 0xa9, 0x79, 0x25, 0x12, 0xcc,
	0x0a, 0x8c, 0x1a, 0x2c, 0x41, 0x30, 0xae, 0x93, 0xe7, 0x89, 0x47, 0x72, 0x8c, 0x17, 0x1e, 0xc9,
	0x31, 0x3e, 0x78, 0x24, 0xc7, 0x38, 0xe1, 0xb1, 0x1c, 0xc3, 0x85, 0xc7, 0x72, 0x0c, 0x37, 0x1e,
	0xcb, 0x31, 0x44, 0xe9, 0xa7, 0x67, 0x96, 0x64, 0x94, 0x26, 0xe9, 0x25, 0xe7, 0xe7, 0xea, 0xbb,
	0xe6, 0x66, 0xe6, 0xb8, 0x43, 0x5d, 0xa7, 0x0f, 0xf3, 0x4a, 0x05, 0x9c, 0x55, 0x52, 0x59, 0x90,
	0x5a, 0x9c, 0xc4, 0x06, 0xf6, 0x8a, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x85, 0xc0, 0x81, 0x5e,
	0xec, 0x00, 0x00, 0x00,
}
...
func (m *FinishedLottery) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Payment != 0 {
		i = encodeVarintFinishedLottery(dAtA, i, uint64(m.Payment))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Winner) > 0 {
...
func (m *FinishedLottery) Size() (n int) {
	...
	if m.Payment != 0 {
		n += 1 + sovFinishedLottery(uint64(m.Payment))
	}
	return n
}
