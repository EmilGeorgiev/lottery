...
func (m *FinishedLottery) GetIndex() uint64 {
	if m != nil {
		return m.Index
	}
	return 0
...
var fileDescriptor_b20ea49878d19341 = []byte{
	...
	0x25, 0x08, 0xc2, 0x11, 0x12, 0xe3, 0x62, 0x2b, 0xcf, 0xcc, 0xcb, 0x4b, 0x2d, 0x92, 0x60, 0x52,
	0x60, 0xd4, 0xe0, 0x0c, 0x82, 0xf2, 0x40, 0xe2, 0x45, 0xa9, 0xe5, 0x89, 0x45, 0x29, 0x12, 0xcc,
	0x60, 0xe5, 0x50, 0x9e, 0x93, 0xe7, 0x89, 0x47, 0x72, 0x8c, 0x17, 0x1e, 0xc9, 0x31, 0x3e, 0x78,
	0x24, 0xc7, 0x38, 0xe1, 0xb1, 0x1c, 0xc3, 0x85, 0xc7, 0x72, 0x0c, 0x37, 0x1e, 0xcb, 0x31, 0x44,
	0xe9, 0xa7, 0x67, 0x96, 0x64, 0x94, 0x26, 0xe9, 0x25, 0xe7, 0xe7, 0xea, 0xbb, 0xe6, 0x66, 0xe6,
	0xb8, 0x43, 0xdd, 0xa6, 0x0f, 0xf3, 0x48, 0x05, 0x9c, 0x55, 0x52, 0x59, 0x90, 0x5a, 0x9c, 0xc4,
	0x06, 0xf6, 0x88, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x8c, 0xc7, 0xf8, 0x52, 0xea, 0x00, 0x00,
	0x00,
}
...
func (m *FinishedLottery) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Index != 0 {
		i = encodeVarintFinishedLottery(dAtA, i, uint64(m.Index))
		i--
		dAtA[i] = 0x8
	}
...
func (m *FinishedLottery) Size() (n int) {
	...
	_ = l
	if m.Index != 0 {
		n += 1 + sovFinishedLottery(uint64(m.Index))
	}
	l = len(m.Winner)
	if l > 0 {
