...
// source: lottery/system_info.proto
...
type SystemInfo struct {
	...
	LotteryPool uint64 `protobuf:"varint,2,opt,name=lotteryPool,proto3" json:"lotteryPool,omitempty"`
}
...
func (*SystemInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_76b3e061808768c6, []int{0}
}
...
func (m *SystemInfo) GetLotteryPool() uint64 {
	if m != nil {
		return m.LotteryPool
	}
	return 0
}

func init() {
	proto.RegisterType((*SystemInfo)(nil), "emilgeorgiev.lottery.lottery.SystemInfo")
}

func init() { proto.RegisterFile("lottery/system_info.proto", fileDescriptor_76b3e061808768c6) }

var fileDescriptor_76b3e061808768c6 = []byte{
	// 179 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *SystemInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.LotteryPool != 0 {
		i = encodeVarintSystemInfo(dAtA, i, uint64(m.LotteryPool))
		i--
		dAtA[i] = 0x10
	}
	if m.NextId != 0 {
...
func (m *SystemInfo) Size() (n int) {
	...
	if m.LotteryPool != 0 {
		n += 1 + sovSystemInfo(uint64(m.LotteryPool))
	}
	return n
}
...
func (m *SystemInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LotteryPool", wireType)
			}
			m.LotteryPool = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LotteryPool |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
