...
const baseSystemInfo: object = { nextId: 0, lotteryPool: 0 };
...
export const SystemInfo = {
  encode(message: SystemInfo, writer: Writer = Writer.create()): Writer {
    ...
    if (message.lotteryPool !== 0) {
      writer.uint32(16).uint64(message.lotteryPool);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.lotteryPool = longToNumber(reader.uint64() as Long);
          break;
        default:
  ...
  fromJSON(object: any): SystemInfo {
    ...
    if (object.lotteryPool !== undefined && object.lotteryPool !== null) {
      message.lotteryPool = Number(object.lotteryPool);
    } else {
      message.lotteryPool = 0;
    }
    return message;
  },
  ...
  toJSON(message: SystemInfo): unknown {
    ...
    message.lotteryPool !== undefined &&
      (obj.lotteryPool = message.lotteryPool);
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<SystemInfo>): SystemInfo {
    ...
    if (object.lotteryPool !== undefined && object.lotteryPool !== null) {
      message.lotteryPool = object.lotteryPool;
    } else {
      message.lotteryPool = 0;
    }
    return message;
