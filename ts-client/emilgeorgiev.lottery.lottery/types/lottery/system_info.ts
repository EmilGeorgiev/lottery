...
export const SystemInfo = {
  ...
  fromJSON(object: any): SystemInfo {
    return {
      ...
      lotteryPool: isSet(object.lotteryPool) ? Number(object.lotteryPool) : 0,
    };
  },
  ...
  toJSON(message: SystemInfo): unknown {
    ...
    message.lotteryPool !== undefined && (obj.lotteryPool = Math.round(message.lotteryPool));
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<SystemInfo>, I>>(object: I): SystemInfo {
    ...
    message.lotteryPool = object.lotteryPool ?? 0;
    return message;
  },
};
