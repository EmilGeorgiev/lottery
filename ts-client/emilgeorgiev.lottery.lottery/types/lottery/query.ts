...
export const QueryGetLotteryRequest = {
  encode(_: QueryGetLotteryRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<QueryGetLotteryRequest>, I>>(_: I): QueryGetLotteryRequest {
    const message = createBaseQueryGetLotteryRequest();
    return message;
  },
};
...
function createBaseQueryGetFinishedLotteryRequest(): QueryGetFinishedLotteryRequest {
  return { index: "" };
}

export const QueryGetFinishedLotteryRequest = {
  encode(message: QueryGetFinishedLotteryRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.index !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryGetFinishedLotteryRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryGetFinishedLotteryRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial<I extends Exact<DeepPartial<QueryGetFinishedLotteryRequest>, I>>(
    object: I,
...
function createBaseQueryGetFinishedLotteryResponse(): QueryGetFinishedLotteryResponse {
  return { finishedLottery: undefined };
}

export const QueryGetFinishedLotteryResponse = {
  encode(message: QueryGetFinishedLotteryResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.finishedLottery !== undefined) {
      FinishedLottery.encode(message.finishedLottery, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): QueryGetFinishedLotteryResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryGetFinishedLotteryResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.finishedLottery = FinishedLottery.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): QueryGetFinishedLotteryResponse {
    return {
      finishedLottery: isSet(object.finishedLottery) ? FinishedLottery.fromJSON(object.finishedLottery) : undefined,
    };
  },
  ...
  toJSON(message: QueryGetFinishedLotteryResponse): unknown {
    ...
    message.finishedLottery !== undefined
      && (obj.finishedLottery = message.finishedLottery ? FinishedLottery.toJSON(message.finishedLottery) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<QueryGetFinishedLotteryResponse>, I>>(
    object: I,
  ): QueryGetFinishedLotteryResponse {
    const message = createBaseQueryGetFinishedLotteryResponse();
    message.finishedLottery = (object.finishedLottery !== undefined && object.finishedLottery !== null)
      ? FinishedLottery.fromPartial(object.finishedLottery)
      : undefined;
    return message;
  },
};

function createBaseQueryAllFinishedLotteryRequest(): QueryAllFinishedLotteryRequest {
  return { pagination: undefined };
}

export const QueryAllFinishedLotteryRequest = {
  encode(message: QueryAllFinishedLotteryRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryAllFinishedLotteryRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryAllFinishedLotteryRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAllFinishedLotteryRequest>, I>>(
    object: I,
...
function createBaseQueryAllFinishedLotteryResponse(): QueryAllFinishedLotteryResponse {
  return { finishedLottery: [], pagination: undefined };
}

export const QueryAllFinishedLotteryResponse = {
  encode(message: QueryAllFinishedLotteryResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryAllFinishedLotteryResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryAllFinishedLotteryResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.finishedLottery.push(FinishedLottery.decode(reader, reader.uint32()));
          break;
        case 2:
  ...
  fromJSON(object: any): QueryAllFinishedLotteryResponse {
    return {
      finishedLottery: Array.isArray(object?.finishedLottery)
        ? object.finishedLottery.map((e: any) => FinishedLottery.fromJSON(e))
        : [],
  ...
  toJSON(message: QueryAllFinishedLotteryResponse): unknown {
    ...
    if (message.finishedLottery) {
      obj.finishedLottery = message.finishedLottery.map((e) => e ? FinishedLottery.toJSON(e) : undefined);
    } else {
      obj.finishedLottery = [];
    }
    message.pagination !== undefined
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAllFinishedLotteryResponse>, I>>(
    object: I,
  ): QueryAllFinishedLotteryResponse {
    const message = createBaseQueryAllFinishedLotteryResponse();
    message.finishedLottery = object.finishedLottery?.map((e) => FinishedLottery.fromPartial(e)) || [];
    message.pagination = (object.pagination !== undefined && object.pagination !== null)
...
export interface Query {
  ...
  FinishedLottery(request: QueryGetFinishedLotteryRequest): Promise<QueryGetFinishedLotteryResponse>;
  /** Queries a list of FinishedLottery items. */
  FinishedLotteryAll(request: QueryAllFinishedLotteryRequest): Promise<QueryAllFinishedLotteryResponse>;
}
...
export class QueryClientImpl implements Query {
  ...
  constructor(rpc: Rpc) {
    ...
    this.FinishedLottery = this.FinishedLottery.bind(this);
    this.FinishedLotteryAll = this.FinishedLotteryAll.bind(this);
  }
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    const data = QueryParamsRequest.encode(request).finish();
    const promise = this.rpc.request("emilgeorgiev.lottery.lottery.Query", "Params", data);
    return promise.then((data) => QueryParamsResponse.decode(new _m0.Reader(data)));
  }

  Lottery(request: QueryGetLotteryRequest): Promise<QueryGetLotteryResponse> {
    const data = QueryGetLotteryRequest.encode(request).finish();
    const promise = this.rpc.request("emilgeorgiev.lottery.lottery.Query", "Lottery", data);
  ...
  SystemInfo(request: QueryGetSystemInfoRequest): Promise<QueryGetSystemInfoResponse> {
    ...
    const promise = this.rpc.request("emilgeorgiev.lottery.lottery.Query", "SystemInfo", data);
  ...
  FinishedLottery(request: QueryGetFinishedLotteryRequest): Promise<QueryGetFinishedLotteryResponse> {
    ...
    const promise = this.rpc.request("emilgeorgiev.lottery.lottery.Query", "FinishedLottery", data);
    return promise.then((data) => QueryGetFinishedLotteryResponse.decode(new _m0.Reader(data)));
  }

  FinishedLotteryAll(request: QueryAllFinishedLotteryRequest): Promise<QueryAllFinishedLotteryResponse> {
    const data = QueryAllFinishedLotteryRequest.encode(request).finish();
    const promise = this.rpc.request("emilgeorgiev.lottery.lottery.Query", "FinishedLotteryAll", data);
    return promise.then((data) => QueryAllFinishedLotteryResponse.decode(new _m0.Reader(data)));
  }
}
